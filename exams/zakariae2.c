...
static void on_activate(GtkApplication *app, gpointer user_data) {
    ...
    fenetre.title = malloc(strlen("zakariae2") + 1);
    strcpy(fenetre.title, "zakariae2");
...
int main(int argc, char *argv[]) {
    GtkApplication *app = gtk_application_new("fr.exam.zakariae2", G_APPLICATION_DEFAULT_FLAGS);
