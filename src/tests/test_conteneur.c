...
static void on_activate(GtkApplication *app, gpointer user_data)
{
    ...
    esp0.bordure_largeur = 1; esp0.bordure_couleur = "#F9A825"; esp0.bordure_rayon = 4;
    ...
    esp30.bordure_largeur = 1; esp30.bordure_couleur = "#C62828"; esp30.bordure_rayon = 4;
    ...
    hom_false.bordure_largeur = 1; hom_false.bordure_couleur = "#3949AB"; hom_false.bordure_rayon = 4;
    ...
    hom_true.bordure_largeur = 1; hom_true.bordure_couleur = "#6A1B9A"; hom_true.bordure_rayon = 4;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        ca.bordure_largeur = 1; ca.bordure_couleur = align_colors[i]; ca.bordure_rayon = 4;
    ...
    exp_false.bordure_largeur  = 1; exp_false.bordure_couleur = "#00695C"; exp_false.bordure_rayon = 4;
    ...
    exp_true.bordure_largeur  = 1; exp_true.bordure_couleur = "#1B5E20"; exp_true.bordure_rayon = 4;
    ...
    sv.bordure_largeur  = 2; sv.bordure_couleur = "#388E3C"; sv.bordure_rayon = 6;
    ...
    for (int i = 1; i <= 12; i++) {
        char t[40]; snprintf(t, sizeof(t), "Ligne verticale %d", i);
    ...
    sh.bordure_largeur  = 2; sh.bordure_couleur = "#1565C0"; sh.bordure_rayon = 6;
    ...
    for (int i = 1; i <= 10; i++) {
        char t[40]; snprintf(t, sizeof(t), "Colonne %d (large)", i);
    ...
    sb.bordure_largeur  = 2; sb.bordure_couleur = "#E65100"; sb.bordure_rayon = 6;
